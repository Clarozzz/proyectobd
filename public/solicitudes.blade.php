            ...
            <div class="col-3">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <h6 class="text-center"><strong>Direccion actual:</strong> </h6>
                        <h6 class="text-center"><strong>Destino:</strong> </h6>
                        <h6 class="text-center"><strong>Fecha:</strong> </h6>
                        <h6 class="text-center"><strong>Sub total:</strong> s</h6>
                        <h6 class="text-center"><strong>Impuesto:</strong> </h6>
                        <h6 class="text-center"><strong>Total:</strong> </h6>
                        <h6 class="text-center"><strong>Cliente:</strong> </h6>
